...
class ArtifactStore:
    ...
    def _artifact_dir(self, workflow_id: str, task_id: str) -> Path:
        """Get the directory for a specific task's artifacts."""
        d = self.base_dir / workflow_id / task_id
    ...
    def save_artifact(self, artifact: Artifact) -> str:
        ...
        """
        try:
            directory = self._artifact_dir(artifact.workflow_id, artifact.task_id)
